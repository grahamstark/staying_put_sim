...
#        EmploymentStatus
    ...
    function sefton(
        ...
        council_data :: DataFrameRow,
        params       :: Params ) :: CarerOutcomes
        outcomes = basiccalc( ccode, year, carer, yp, council_data, params )
    ...
    function randomoldhamfee(
        year         :: Integer,
        carer        :: Carer,
        yp           :: YP,
        fees         :: Vector ) :: Real
        fee = oldhamstylefee( year, carer, yp, fees )
    ...
    FUNCS["XXHerefordshire"]=function( cohort :: Vector, data :: DataFrameRow, params :: Params )
        frame = basiccalc( "Herefordshire", cohort, data, params )
        # £118.00 per week. £210 (£118.00 + £92.00) if the young person does not receive housing benefits.
    end
    ...
    FUNCS["XXWigan"]=function( cohort :: Vector, data :: DataFrameRow, params :: Params )
        frame = basiccalc( "Wigan", cohort, data, params )
    ...
    function ealing(
        ...
        council_data :: DataFrameRow,
        params       :: Params ) :: CarerOutcomes
        fee = oldhamstylefee( year, carer, yp, [0, 78.38, 158.76, 237.23, 340.76] )
